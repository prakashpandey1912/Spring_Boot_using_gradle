...
el.setAttribute('src','/CaptchaCode?dt='+dateTime);
}
</script>
</head>
...
<div class="form-group"><label class="small mb-1" for="inputUserName">User Name</label><input class="form-control py-4" id="userName" type="text" name="username" value="${customerBean.username}" placeholder="Enter user name" required /><span style="color:red">${registrationError.username}</span></div>



<div class="form-group"><label class="small mb-1" for="inputEmailAddress">Email</label><input class="form-control py-4" id="emailId" type="email" name="emailId" value="${customerBean.emailId}" aria-describedby="emailHelp" placeholder="Enter email address" required /><span style="color:red" color='red'>${registrationError.emailId}</span></div>
...
<img  class=" py-4" src='/CaptchaCode?dt=h1' id='CaptchaCode' >
<img src='images/refresh.png' height="20px" width="20px" onclick='refresh()' ></div>
</div>
</div>
